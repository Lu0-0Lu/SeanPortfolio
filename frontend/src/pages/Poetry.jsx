...
export default function Poetry() {
  ...
  useEffect(() => {
    fetch('http://localhost:5000/api/poetry')
      ...
      .then((data) => {
        setPoetry(data);
        // REMOVED: The auto-expand logic so all cards start closed
        setLoading(false);
        // Trigger the staggered entry animation right after the DOM renders the list
      ...
      <div className="min-h-screen bg-slate-50 text-slate-900 transition-all duration-300 dark:bg-[#121212] dark:text-slate-100">
        ...
        <MainLayout>
          <main className="mx-auto max-w-6xl space-y-16 pb-20 pt-16 sm:pt-24">
            ...
            <div className="border-b border-slate-200 pb-10 text-center dark:border-slate-800 animate-fade-in-up">
