...
export default function NotFound() {
  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen bg-slate-50 text-slate-900 transition-colors duration-500 dark:bg-[#121212] dark:text-slate-100 flex flex-col relative overflow-hidden">
        
        {/* Richer, Distinct Starry Background Elements */}
        <div className="absolute inset-0 z-0 pointer-events-none">
          <div className="absolute top-[15%] left-[20%] h-1.5 w-1.5 bg-slate-500 dark:bg-white rounded-full animate-pulse transition-colors duration-500"></div>
          <div className="absolute top-[25%] left-[80%] h-2 w-2 bg-slate-600 dark:bg-blue-400 rounded-full opacity-80 transition-colors duration-500"></div>
          <div className="absolute top-[60%] left-[10%] h-1.5 w-1.5 bg-slate-500 dark:bg-white rounded-full opacity-70 animate-pulse transition-colors duration-500"></div>
          <div className="absolute top-[75%] left-[75%] h-2.5 w-2.5 bg-slate-600 dark:bg-indigo-300 rounded-full opacity-60 transition-colors duration-500"></div>
          <div className="absolute top-[40%] left-[50%] h-1.5 w-1.5 bg-slate-500 dark:bg-white rounded-full opacity-90 transition-colors duration-500"></div>
          <div className="absolute top-[10%] left-[50%] h-2 w-2 bg-slate-600 dark:bg-white rounded-full opacity-50 transition-colors duration-500"></div>
          <div className="absolute top-[80%] left-[25%] h-2 w-2 bg-slate-600 dark:bg-blue-300 rounded-full opacity-70 transition-colors duration-500"></div>
        </div>

        <Navbar />
        
        <MainLayout className="flex-1 flex flex-col justify-center relative z-10">
          <main className="flex-1 grid items-center gap-12 lg:grid-cols-2 px-4 py-16 animate-fade-in-up">
            
            {/* Left Column: Clean Text & Buttons */}
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left space-y-6">
              
              <h1 className="text-8xl sm:text-[10rem] lg:text-[11rem] font-extrabold tracking-tighter text-slate-900 dark:text-white leading-none drop-shadow-sm transition-colors duration-500">
                404
              </h1>
              
              <div className="space-y-4">
                <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-slate-900 dark:text-white transition-colors duration-500">
                  Page Not Found
                </h2>
                <p className="max-w-md text-slate-600 dark:text-slate-400 text-base sm:text-lg leading-relaxed transition-colors duration-500">
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start pt-4">
                <button 
                  onClick={() => navigate('/')}
                  className="rounded-full bg-slate-900 px-8 py-3.5 text-sm font-bold text-white transition-all hover:bg-slate-800 hover:-translate-y-1 shadow-sm dark:bg-white dark:text-[#121212] dark:hover:bg-slate-200"
                >
                  Return Home
                </button>
                <button 
                  onClick={() => navigate(-1)}
                  className="rounded-full border border-slate-300 bg-transparent px-8 py-3.5 text-sm font-bold text-slate-900 transition-all hover:border-slate-400 hover:-translate-y-1 dark:border-slate-700 dark:text-white dark:hover:border-slate-500"
                >
                  Go Back
                </button>
              </div>
            ...
            <div className="relative flex justify-center lg:justify-end animate-float">
              ...
              >
                ...
                <path d="M117.86,50.2a1,1,0,0,0-1-.71,1,1,0,0,0-1,.71,5.88,5.88,0,0,1-3.88,3.88,1,1,0,0,0-.7,1,1,1,0,0,0,.7,1A5.84,5.84,0,0,1,116,59.87a1,1,0,0,0,1,.71,1,1,0,0,0,1-.71A5.88,5.88,0,0,1,121.75,56a1,1,0,0,0,.7-1,1,1,0,0,0-.7-1A5.9,5.9,0,0,1,117.86,50.2Zm-1,7.06A8,8,0,0,0,114.68,55a7.86,7.86,0,0,0,2.23-2.22A7.82,7.82,0,0,0,119.13,55,8,8,0,0,0,116.91,57.26Z"></path>
                <path d="M15.27,117.28a1,1,0,0,0,1.91,0,5.52,5.52,0,0,1,3.64-3.64,1,1,0,0,0,.71-1,1,1,0,0,0-.71-1,5.5,5.5,0,0,1-3.64-3.64,1,1,0,0,0-1.91,0,5.5,5.5,0,0,1-3.64,3.64,1,1,0,0,0-.71,1,1,1,0,0,0,.71,1A5.52,5.52,0,0,1,15.27,117.28Zm1-6.6a7.39,7.39,0,0,0,2,2,7.26,7.26,0,0,0-2,2,7.43,7.43,0,0,0-2-2A7.57,7.57,0,0,0,16.23,110.68Z"></path>
              </svg>
            </div>
